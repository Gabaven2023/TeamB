...
[glink  color="blue"  storage="scene2.ks"  size="28"  x="360"  width="500"  y="150"  text="はぁ？そんなことねぇし。"  target="*selectinterest1"  ]
[glink  color="blue"  storage="scene3.ks"  size="28"  x="360"  width="500"  y="250"  text="知ってたのかよ。"  target="*selectinterest2"  ]
